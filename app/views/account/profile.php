    ...
    <div class="box-transparent profile">
        <div class="profile__skin">
            <canvas class="skin-3d" width="300" height="460"
                    style="cursor:move;width:300px;background-color:antiquewhite;" data-skin-hash="85986e8101adf9be" data-model="slim"
